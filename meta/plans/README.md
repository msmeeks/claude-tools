...
|------|--------|--------|------|--------|
| [ralph-prd-json-data-layer.md](ralph-prd-json-data-layer.md) | `feat/ralph-prd-json-data-layer` | #2 | M | pending |
| [ralph-orchestration-loop.md](ralph-orchestration-loop.md) | `feat/ralph-orchestration-loop` | #3 | L | pending |
| [ralph-triage-issues-prd-json.md](ralph-triage-issues-prd-json.md) | `feat/ralph-triage-issues-prd-json` | #5 | M | pending |
| [ralph-docker-sandbox.md](ralph-docker-sandbox.md) | `feat/ralph-docker-sandbox` | #4 | M | pending |
| [ralph-triage-pr-comments-prd-json.md](ralph-triage-pr-comments-prd-json.md) | `feat/ralph-triage-pr-comments-prd-json` | #6 | M | pending |
| [ralph-sdlc-review-gate.md](ralph-sdlc-review-gate.md) | `feat/ralph-sdlc-review-gate` | — | M | pending |

## Suggested Order

1. **`feat/ralph-prd-json-data-layer`** (#2) — foundation; all other plans depend on the prd.json schema and data layer it defines
2. **`feat/ralph-orchestration-loop`** (#3) + **`feat/ralph-triage-issues-prd-json`** (#5) — can run in parallel; #3 touches only `scripts/run-next-plan.py`, #5 touches only `skills/triage-issues/SKILL.md`
...
- `skills/triage-issues/SKILL.md` is modified only by #5 — no conflict with #3 or #4.
